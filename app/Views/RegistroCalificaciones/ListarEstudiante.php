            ...
            <div class="card-body">
                ...
                <tbody>                   
                    ...
                    <tr>
                        ...
                        <td><button type="button" onclick="location.href='<?php echo base_url();?>/RegistroCalificacionesController/indexCalificacion?id=<?php echo $item['ESTID'];?>&mat=<?php echo $item['MATID'];?>'" class="btn btn-primary">Ver Calificaciones</button></td>                        
                    </tr>
