            ...
            <div class="card-body">
                ...
                <tbody>                   
                    ...
                    <tr>
                        ...
                        <td><button type="button" onclick="location.href='<?php echo base_url();?>/RegistroCalificacionesController/indexEstudiantes?id=<?php echo $curso['CURID'];?>'" class="btn btn-primary">Ver Estudiantes</button></td>                        
                    </tr>
